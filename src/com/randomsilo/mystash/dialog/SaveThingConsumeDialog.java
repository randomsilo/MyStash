...
public class SaveThingConsumeDialog {
	...
	public static void show(final Activity activity) {
		...
		dialog.setContentView(R.layout.dialog_save_thing_consume);
		dialog.setTitle(R.string.dialog_save_thing_consume_title);
		...
		ThingConsumeModel c = MyStashSession.getInstance().getActiveConsumeModel();
		...
		saveBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				ThingConsume tc = new ThingConsume(); 
				...
				// Save ThingConsume
				MyStashSession.getInstance().getThingService().getThingConsumeDao().save(tc);
				
				// Refresh Activity
				((ThingResourceActivity)activity).RefreshConsumeList();
		...
		removeBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Remove ThingConsume
				MyStashSession.getInstance().getThingService().getThingConsumeDao().delete(tc);
